"------------------------------------------------------------------------------
" sources for helpful vimrc configs
" 1. https://github.com/lightningWhite/SetupDevEnvironment
...
" Brief help
"  :source $MYVIMRC   - source the .vimrc file before trying to run Plug
"                       commands
...
" Note: vim-gtk needs to be installed since it supports
...
"set directory^=$HOME/.vim/tempSwapFiles//
